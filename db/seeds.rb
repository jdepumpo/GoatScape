...
10.times do |i|
  goat = Goat.create(name: Faker::Name.first_name, category: cat[rand(0..7)], location: Faker::Address.state, age: rand(1..20), user_id: 1, image_url: urls[rand(0..23)], description: lorem)
  puts "goat #{i} created"
  puts goat.name
  puts goat.user_id
end
